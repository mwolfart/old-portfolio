...
export class OSTools extends React.Component {
    render() {
        return (
            <div className="screen-content__main-panel">
                <div className="screen-content__text-panel">
                    ...
                    <div className="screen-content__text-description">
                        ...
                        You can find the project repository <a href="http://bitbucket.org/mwolfart/sisop-i-cthreads/src">here</a>. In order to use the library you can build the Makefile and import the file libcthread.a under the lib folder.
                    </div>
                    <div className="screen-content__text-title">T2FS</div>
                    <div className="screen-content__text-description">
                        This is a custom operational file system. It contains many functions to manage files and folders, such as listing files, creation of directories, file relocation, etc. - basically all simple unix commands contain their counterparts in it.
                        In this project the team has also split roles, but many helper functions were implemented in order to provide a more readable code base, and some of the hardest functions were implemented by all members during a virtual coding session.
